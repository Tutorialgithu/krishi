        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <p>
                For Any Problem <a href="tel:+919238114481" className="hover:underline">+91 0000000000</a>
              </p>
              <p>
                For sales: <a href="tel:+917000528397" className="hover:underline">+91 0000000000</a>
              </p>
              <p>
                <a href="mailto:support@BioTech.in" className="hover:underline">support@BioTech.in</a>
              </p>
            </div>
          </div>
          {/* Contact Part ended */}
