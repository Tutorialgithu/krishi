...
const handleLogout=()=>{
  localStorage.removeItem('DKAUTH')
  ...
  return (
   ...
   <div>
      <button
        className="md:hidden fixed top-4 left-4 z-50 text-xl bg-white p-2 rounded shadow"
      ...
      <nav
        className={`bg-white shadow-lg h-screen fixed top-0 left-0 md:min-w-[250px] py-4 px-4 font-[sans-serif] overflow-auto transition-transform transform ${
          isOpen ? 'translate-x-0' : '-translate-x-full'
        } md:translate-x-0`}
      >
        <a href="#">
          <img src="../src/assets/BHARTIYA.jpg" alt="logo" className="w-[120px]" />
        </a>
          ...
          <ul className="mt-3">
            ...
            <li>
              ...
              >
                ...
                <span>
                  <Link to="/ProductDashboard">Show All Products</Link>
                </span>
              </a>
            </li>
            <li>
              <a
                ...
                className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4" viewBox="0 0 510 510">
                  <g fillOpacity=".9">
                ...
                <span>
                  <Link to="/ProductRequest">Order Request</Link>
                </span>
              </a>
            </li>
            <li>
          ...
          <ul className="mt-3">
            ...
            <li>
              <a
                ...
                className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4" viewBox="0 0 6.35 6.35">
